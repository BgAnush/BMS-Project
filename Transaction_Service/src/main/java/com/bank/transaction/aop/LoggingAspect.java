...
public class LoggingAspect {
    ...
    @Around("execution(* com.bank.transaction.controller.*.*(..))")
    ...
    @Around("execution(* com.bank.transaction.service.*.*(..))")
    ...
    @Around("execution(* com.bank.transaction.repository.*.*(..))")
    ...
    @Around("execution(* com.bank.transaction.client.*.*(..))")
    public Object logClientMethods(
        ...
        try {
            ...
            log.info(
                    "CLIENT CALL SUCCESS :: {}.{} :: result={} :: executionTime={} ms",
                    className,
                    methodName,
                    result,
                    (end - start)
            ...
            log.error(
                    "CLIENT CALL ERROR :: {}.{} :: error={} :: executionTime={} ms",
                    className,
                    methodName,
                    ex.getMessage(),
                    (end - start)
